    ...
    <main class="perfil-main">
      ...
      <div v-else-if="datos.usuario" class="perfil-content">
        ...
        <div class="info-table">
          ...
          <!-- Datos del estudiante (solo si existen) -->
          <template v-if="datos.extra">
            ...
            <div class="info-row">
              ...
              <span class="info-value">{{ datos.extra.grupo?.nombre || 'Sin grupo asignado' }}</span>
            </div>
          </template>
        </div>
...
onMounted(async () => {
  console.log('Cargando perfil del estudiante con ID:', id)
  ...
  try {
    ...
    // Verificar si tenemos los datos del estudiante
    if (!res.data.extra) {
      console.warn('No se encontraron datos de estudiante')
    }
  } catch (e) {
